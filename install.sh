...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/aria2"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="aria2"
INSTDIR="$HOME/.local/share/dockermgr/aria2"
APPDIR="$HOME/.local/share/srv/docker/aria2"
DATADIR="$HOME/.local/share/srv/docker/aria2/files"
...
HUB_URL="casjaysdevdocker/aria2:latest"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
if [ -z "$HUB_URL" ] || [ "$HUB_URL" = "hello-world" ] || echo "$HUB_URL" | grep -q "aria2"; then
